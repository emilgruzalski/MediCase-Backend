...
namespace MediCase.WebAPI.Services
{
    public class VoiceGeneratorService : IVoiceGeneratorService
    {
        ...
        { 
            ...
            {
                {"US", Tuple.Create<string, string>("en-US", "Joanna")},
                {"PL", Tuple.Create<string, string>("pl-PL", "Ola")},
                {"DE", Tuple.Create<string, string>("de-DE", "Daniel")},
                {"FR", Tuple.Create<string, string>("fr-FR", "Rémi")},
                {"ES", Tuple.Create<string, string>("es-US", "Pedro")}
            };
        }
