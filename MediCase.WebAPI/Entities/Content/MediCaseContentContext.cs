...
public partial class MediCaseContentContext : DbContext
{
    public MediCaseContentContext()
    {
    }

    public MediCaseContentContext(DbContextOptions<MediCaseContentContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("name=ConnectionStrings:Content", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.6.14-mariadb"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EntityTranslation>(entity =>
        {
            ...
            entity.HasIndex(e => e.LangId, "LangId1");
